...
'Enter a value': 'Inserir um valor',
'Enter an integer between %(min)g and %(max)g': 'Informe um valor inteiro entre %(min)g e %(max)g',
'Enter date as %(format)s': 'Inserir data no formato %(format)s',
'Enter time as hh:mm:ss (seconds, am, pm optional)': 'Inserir hora no formato hh:mm:ss (segundos, am, pm opcional)',
'Errors': 'Erros',
...
'formSalas.errors[fieldname]': 'formSalas.errors[fieldname]',
...
'Horário de entrada': 'Horário de entrada',
...
'Request reset password': 'Solicitar alteração de senha',
'Request Reset Password': 'Solicitar Alteração de Senha',
...
'Twitter': 'Twitter',
'Tópico de Entrada': 'Tópico de Entrada',
'Tópico de Saída': 'Tópico de Saída',
